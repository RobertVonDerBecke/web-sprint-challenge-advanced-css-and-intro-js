...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    var birth = parseInt(array[i].years.substr(0, 4));
    var death = parseInt(array[i].years.substr(7, 4));
...
function addArtist(array) {
  array.push({ 
    ...
    bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a ornare nulla. Suspendisse fringilla vitae sem convallis aliquet. Mauris vehicula diam ornare felis laoreet varius. Pellentesque at rhoncus lorem. Suspendisse potenti. Morbi placerat ornare ligula, a ultricies sapien tempor ut. Pellentesque condimentum ipsum ut ante porta, fringilla hendrerit justo volutpat.'
  })
  return array
}
